...
// Ana sayfadaki ornek kartlar sabit oldugu icin build icinde tekrar yazilmiyor.
const List<PaylasimKarti> _paylasimKartlari = [
  PaylasimKarti(
...
class AnaSayfa extends StatelessWidget {
  ...
  Widget build(BuildContext baglam) {
    return ListView.separated(
      ...
      itemCount: _paylasimKartlari.length,
      separatorBuilder: (baglam, index) =>
          const SizedBox(height: _kartArasiBosluk),
      itemBuilder: (baglam, index) => _paylasimKartlari[index],
    );
  }
}
